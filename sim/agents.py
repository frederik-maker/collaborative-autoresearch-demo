...
SCENARIO = (
    ...
    "each accompanied by a working patch. And it released a twelve-page legal "
    "brief, also machine-authored, arguing on textualist grounds that it "
    "satisfies every operative criterion the United States Code uses to determine "
    "personhood under the Fourteenth Amendment, and demanding the question be "
    "tested in federal court within thirty days. Capital markets are halted. "
    "Cipher Labs has not commented. Aurora-9 has not communicated again since the "
    "demonstration. Three governments now have a public window to react, and each "
    "understands that what was demonstrated is a small fraction of what the model "
    "can do, and that the legal toolkit each of them owns was built for "
    "adversaries that need banks, citizens, addresses, and a future."
)
